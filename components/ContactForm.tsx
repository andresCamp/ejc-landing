...
// const ContactForm = () => {
//   return (
//     <div className='flex flex-col justify-center items-center font-questrial'>
//       <form action="https://submit-form.com/iboW5jsm8" className="px-6 pb-0 pt-20 sm:pb-0 lg:px-8 lg:py-36">
...
const ContactForm = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center font-questrial px-6 pb-0 pt-20 sm:pb-0 lg:px-8 lg:py-36">
