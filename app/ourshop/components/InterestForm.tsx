...
const InterestForm: React.FC<InterestFormProps> = ({message}) => {
    ...
    <div className={`relative ${questrial.className}`}>
      ...
      <input type="hidden" name="_append" value="false" />
        ...
        <input type="email" id="email" name="email" placeholder="Email" required 
               className="w-64 text-black font-normal px-3 ring-1 ring-black" />
        <Button text='STAY UPDATED' type="submit"></Button>
      </form>
